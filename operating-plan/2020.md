...
<a name=”expense-polcies>
### Expense Polcies
Provided budget limitations, the Foudation will generally follow a “fair and reasonable” expense policy. Chapters and projects will be provided guidelines at the begnning of every calendar year for their planning. Expenses that are expected to exceed $1,500 must be pre-approved and expenses greater than $5,000 must be direct billed to the Foundation and do not qualify for reimbursement. The Founation will continue to use JIRA to proces reimbursement with a documented SLA of no more than 22 days for fully documented requests.

<a name=”travel-assistanc”
...
<a name=”corporate-membership>
### Corporate Membership
Corporate support is critial for the growth of the Foundation. Annually the Foundation will survey this membership for feedback while reviewing member benefits and pricing. Minimally, coporate membership benefits will include prominent recognition on the Foudation website. 

<a name=”local-partnerships>
### Local Partnerships
The Foundation will establish processes that enable local chapters to manage local partnerships. Any local partnership, especially those that involve finanical support, shall have an memo of understanding between a local OWASP Champion who shall manage the partership and the Foundation. These agreements are designed to protect all parties, streamline operations, and ensure parterships conform to the mission and ethics of the Foundation.

<a name=”community-outreach>
### Community Outreach
...
<a name=”projoect-summits>
### Project Summits
Minimally twice each year, with one each in different geographies, the Foundation will host three-day working sessions for selected projects. A merit-based selection process will be developed to invite projects to each summit. The program will solely include heads-down work time for OWASP projects. Travel assistance will be provided to selected projects and their key leaders.
