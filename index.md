...
{% for page in pages %}{% if page.path contains 'projects/' %}{% assign ptitle = page.title | strip_newlines  %}* [{{ ptitle }}](/www-staff{{ page.url | strip_newlines }}){% if page.date %}, {{ page.date }}{% endif %}{% endif %}
{% endfor %}
