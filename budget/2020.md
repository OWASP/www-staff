...
Below is the 2020 Draft budget. We ware essentially forecasting a breakeven (net-zero) plan with about 50% growth in Revenue and Expenses. As in historical years, the success of Global Events drive the topline performance for the foundation. These events not only fufulling our mission of education and community, they often give Corporate Supportors additional incentive to financially support the OWASP Foundation. 

If you are curious there is also a [Comparison to FY19 forecasted actuals](/www-staff/budget/2020-compare) for your information. (Sorry I am reworking that webpage to make it more readable.
